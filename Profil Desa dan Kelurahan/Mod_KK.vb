...
start1:
        Try
            With GWB
                ...
                If .DocumentTitle = "Daftar - KEPALA KELUARGA" And _
                    .Document.GetElementById("sc_SC_btn_0_top").TextContent = "KK Baru" Then
...
start2:
                    If .DocumentTitle = "(Data Baru) - KEPALA KELUARGA" Then
                        ...
                        .Document.GetElementsByName("nama_dusun")(0).SetAttribute("value", My.Settings.Kelurahan)
                        .Document.GetElementsByName("d014")(0).SetAttribute("value", My.Settings.Nama_Pengisi)
                        .Document.GetElementsByName("d015")(0).SetAttribute("value", My.Settings.Pekerjaan)
                        .Document.GetElementsByName("d016")(0).SetAttribute("value", My.Settings.Jabatan)
                        Dim sumberDataG As GeckoTextAreaElement
                        sumberDataG = New GeckoTextAreaElement(.Document.GetElementsByName("d017")(0).DomObject)
                        sumberDataG.Value = My.Settings.Sumber_Data
