        ...
        Try
            With GWB
                ...
                If .DocumentTitle = "Daftar - KEPALA KELUARGA" Then
                    ...
                    .Navigate("javascript:nm_gp_submit5('/grid_ddk02/', '/grid_ddk01/', 'nmgp_lig_edit_lapis?#?S?@?kodeklg?#?" + Mod_Select.NO_KK + "?@?namakk?#?" + Mod_Select.NAMA_KEP.Replace("'", "@aspass@") + "?@?kddesa?#?" + My.Settings.Kode_Desa + "?@?', '_self', 'inicio', '0', '0')")
...
start2:
                    ...
                    Else
                        ...
                        My.Settings.NO_KK_AK = txtfind.Text
                        My.Settings.Save()
    ...
    Private Sub Pekerjaan(ByVal GWB As GeckoWebBrowser)
        Select Case Mod_Select.PEKERJAAN
            ...
            Case "Anggota Legislatif".ToUpper, "Anggota DPRD Provinsi".ToUpper, "Anggota DPD".ToUpper, "Anggota DPRD Kabupaten/Kota".ToUpper
            ...
            Case "Tukang Rias".ToUpper, "Penata Rias".ToUpper, "Penata Busana".ToUpper
