...
Module Mod_Other
    ...
    Public Sub Ping(ByVal PingLabel As ToolStripLabel, ByVal PingLabelMs As ToolStripLabel, ByVal TimerPing As Timer, ByVal PingToolStripItem As ToolStripMenuItem)
        If PingToolStripItem.Checked = True Then
            PingLabel.Visible = True
            PingLabelMs.Visible = True
            TimerPing.Enabled = True
        Else
            PingLabel.Visible = False
            PingLabelMs.Visible = False
