...
Public Class Form_PRODESKEL
    ...
    Private Sub Form_PRODESKEL_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        FindAKToolStripTextBox.Text = My.Settings.NO_KK_AK
    ...
    Private Sub LogInToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LogInToolStripMenuItem.Click
        Try
            GWB.Document.GetElementsByName("login")(0).SetAttribute("value", My.Settings.Kode_Desa)
            GWB.Document.GetElementsByName("pswd")(0).SetAttribute("value", My.Settings.Password_Desa)
